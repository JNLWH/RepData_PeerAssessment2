...
Top10Costly <- ggplot(Top10Damage, aes(EVTYPE,TotalDamage/div)) +
...
Top20Costly_byYear <- ggplot(Top20Damage_byYear, 
                             aes(x=BGN_Year, y=TotalDamage/div, fill=TotalDamage)) +
        geom_point(aes(color = EVTYPE, size = TotalDamage)) +
